...
class Blue1DayDetail extends StatefulWidget {
  final int dayIndex;
  final String dayDate;
  final BlueTable1State b;

  const Blue1DayDetail(this.dayIndex, this.dayDate, this.b, {Key key})
      : super(key: key);

  @override
  _Blue1DayDetailState createState() {
    return _Blue1DayDetailState(dayIndex, dayDate, b);
  }
}

class _Blue1DayDetailState extends State<Blue1DayDetail> {
  int dayIndex;
  String dayDate;
  BlueTable1State b;
  double xSize;
  ...
  _Blue1DayDetailState(this.dayIndex, this.dayDate, this.b);
                    ...
                    new Padding(
                      ...
                      child: AutoSizeText(
                        ...
                        style: prefix0.getTextStyle(
                            (dayIndex == 6 || dayIndex == 0) ? (kIsWeb ? 17 : 19)
                                : (kIsWeb ? 22 : 25),
